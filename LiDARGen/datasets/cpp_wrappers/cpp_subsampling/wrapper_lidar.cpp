...
#include "grid_subsampling/grid_subsampling_lidar.h"
#include <string>
...
static PyObject *grid_subsampling_lidar_compute(PyObject *self, PyObject *args, PyObject *keywds);
...
{
	{ "compute", (PyCFunction)grid_subsampling_lidar_compute, METH_VARARGS | METH_KEYWORDS, compute_docstring },
    {NULL, NULL, 0, NULL}
};
...
PyMODINIT_FUNC PyInit_grid_subsampling_lidar(void)
{
    import_array();
...
static PyObject *grid_subsampling_lidar_compute(PyObject *self, PyObject *args, PyObject *keywds)
{
	...
	grid_subsampling_lidar(original_points,
                     subsampled_points,
                     original_features,
                     subsampled_features,
                     original_classes,
